...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Restablecer la contraseña para su cuenta del Museo Arqueológico Berruecos</title>
        <style type="text/css">
            *{  padding: 0;
                margin: 0;
    ...
    <div class="body">
        ...
        <div class="content">
            <div class="main">
                ...
                <p class="p_main">Recientemente solicitó restablecer su contraseña para su cuenta del Museo Arqueológico Berruecos. Use el botón de abajo para establecer una nueva contraseña. <strong> Este restablecimiento de contraseña solo es válido durante las próximas 24 horas.</strong></p>
                <div class="button">
